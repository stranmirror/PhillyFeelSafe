...
const contact = () => {
    return (
        ...
        <div>
            ...
            <h1><br></br>I am a freshman at Drexel University and my major is Computer Science. My goal is learn a few programming languages like C++, R, and Python. </h1>
            <div>
            <br></br>
